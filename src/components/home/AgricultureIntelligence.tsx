...
const sidebarItems = [
  {
    ...
    description:
      "Hyper-local weather tracking and severe storm warnings.",
  },
  {
    ...
    title: "Cost Tracking",
    description:
      "Live profit/loss dashboards for every single acre.",
  },
  {
    ...
    title: "Farm Insights",
    description:
      "Data-driven suggestions for operational efficiency.",
  },
];
