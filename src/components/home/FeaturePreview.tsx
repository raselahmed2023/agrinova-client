...
function FeatureIcon({ icon }: { icon: FeatureIcon }) {
  const paths = {
    crop: (
      <>
        <path d="M5 10h14l-1.1 8H6.1L5 10Z" />
        <path d="M9 6.5h6M12 3.5v3M8.2 14h7.6" />
      </>
    ),
    soil: (
      <>
        <path d="M12 3.5v8" />
        <path d="M12 3.5c-2.6 2.3-4 4.4-4 6.5a4 4 0 1 0 8 0c0-2.1-1.4-4.2-4-6.5Z" />
        <path d="M5 20h14" />
      </>
    ),
    irrigation: (
      <>
        <path d="M12 3.5C8.8 7 7 9.4 7 12a5 5 0 0 0 10 0c0-2.6-1.8-5-5-8.5Z" />
        <path d="M8.5 17.5h7" />
      </>
    ),
    activity: (
      <>
        ...
        <path d="M9 4V2.8M15 4V2.8M8.5 10h7M8.5 14h5" />
      </>
    ),
  };
  ...
  return (
    <motion.span
      ...
      className="grid size-10 shrink-0 place-items-center rounded-[10px] bg-[#174d3c] text-white shadow-sm"
    >
      <svg
        viewBox="0 0 24 24"
        className="size-5"
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          <h2
            id="features-title"
            className="text-3xl font-extrabold tracking-[-0.04em] text-[#202934] sm:text-4xl"
          >
            Smart Farm Management
          </h2>

          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-[#48525a]">
            Harness the power of real-time data to streamline your daily
            operations and maximize every acre of your land.
          </p>
        </motion.header>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 md:gap-6 lg:mt-12">
          {features.map((feature, index) => (
            <motion.article
              ...
              className="group grid min-h-[250px] grid-cols-[minmax(0,1fr)_7.25rem] gap-4 overflow-hidden rounded-2xl bg-[#edf4ff] p-4 shadow-sm transition-shadow duration-300 hover:bg-[#e7f1ff] hover:shadow-[0_18px_32px_rgba(34,75,103,0.16)] sm:grid-cols-[minmax(0,1fr)_9.5rem] sm:gap-5 sm:p-5 lg:min-h-[275px] lg:grid-cols-[minmax(0,1fr)_10rem] lg:p-6"
            >
              {/* Content */}
              <div className="flex min-w-0 flex-col">
                <FeatureIcon icon={feature.icon} />

                <h3 className="mt-2.5 text-base font-extrabold tracking-[-0.025em] text-[#27313a] sm:text-lg">
                  {feature.title}
                </h3>

                <p className="mt-2 text-[11px] leading-[1.45] text-[#4a545d] sm:text-xs">
                  {feature.description}
                </p>
                ...
                <ul className="mt-auto space-y-1 pt-4 text-[10px] font-medium text-[#43534e] sm:text-[11px]">
                  {feature.highlights.map((highlight, highlightIndex) => (
                    <motion.li
                      ...
                      transition={{
                        duration: 0.35,
                        delay: index * 0.1 + highlightIndex * 0.08,
                      }}
                      className="flex items-center gap-1.5"
                    >
                      <span
                        aria-hidden="true"
                        className="grid size-2.5 place-items-center rounded-full border border-[#46655b] text-[7px] leading-none"
                      >
                        ✓
                      </span>
              ...
              <motion.div
                ...
                className="relative my-auto aspect-[.93] w-full overflow-hidden rounded-lg border border-white/80 shadow-sm"
              >
                <Image
                  src={feature.image}
                  ...
                  sizes="(max-width: 640px) 116px, (max-width: 1024px) 152px, 160px"
                />
