...
export default function SellProductForm() {
  ...
  const [form, setForm] =
    useState<ICreateProduct>(initialForm);
  ...
  const submit = async (
    ...
    try {
      ...
      setSuccess(
        "Published. Your product is live in the marketplace now."
      );
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <header className="mt-5 rounded-3xl bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-700 p-6 text-white shadow-lg sm:p-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-emerald-50/90">
                Add the essentials, publish instantly, and update
                stock whenever you need. No admin approval is
          ...
          <div className="mt-5 flex items-center gap-2 rounded-2xl border border-white/15 bg-white/10 px-4 py-3 text-xs leading-5 text-emerald-50">
            ...
            AgriNova may hide or remove listings that violate
            marketplace rules and will send the farmer a
            moderation notice.
          </div>
        </header>
        ...
        <form
          onSubmit={submit}
          className="mt-6 grid gap-6 lg:grid-cols-[1.35fr_.65fr]"
        >
          <div className="space-y-6">
            <Card
              ...
              description="Only the information buyers need to understand the listing."
            >
            ...
            <Card
              title="Price & stock"
              description="Stock is reduced automatically when a buyer places an order."
            >
            ...
            <Card
              ...
              description="Optional, but useful for logistics and nearby buyers."
            >
              <div className="grid gap-5 sm:grid-cols-2">
            ...
            {form.category ===
              ...
              <Card
                ...
                description="Poultry type is required; the rest is optional."
              >
                <div className="grid gap-5 sm:grid-cols-2">
                  <Field
                    label="Poultry type"
            ...
            {form.category ===
              ...
              <Card
                title="Common uses"
                description="Optional: select relevant uses for this by-product."
              >
                <div className="flex flex-wrap gap-2">
                  {BY_PRODUCT_USE_OPTIONS.map(
                    (
                      option
                    ) => {
                      const selected =
          ...
          <aside className="space-y-6 lg:sticky lg:top-6 lg:self-start">
            <Card
              ...
              description="Optional. The first photo becomes the cover."
            >
              <ProductImageUpload
                images={images}
                setImages={
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-xs leading-5 text-slate-500">
                Your listing becomes searchable immediately. You can
                edit quantity, price, photos and details later from
                My Listings.
              </p>
