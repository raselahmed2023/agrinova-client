...
import type { ISellerOrder, ISellerOrderFulfillment } from "@/types/marketplace";
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
              Only orders containing your own products are shown here.
              Prepare each order, mark it ready for pickup, and AgriNova
              admin will coordinate collection and delivery.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="mt-7 rounded-2xl border border-dashed border-slate-300 bg-white p-14 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Orders for your marketplace listings will appear here.
            </p>
          </div>
        ) : (
      ...
      <div className="p-5 sm:p-6">
        ...
        {fulfillment.status ===
          ...
          <div className="mt-5 rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm text-emerald-800">
            AgriNova has been notified.
            Keep the items ready at your
            pickup location while admin
            assigns a collection agent.
          </div>
        )}
