...
export default function InvestPage() {
  ...
  const [nidNumber, setNidNumber] =
    useState("");

  const [paymentMethod, setPaymentMethod] =
    useState<InvestmentPaymentMethod>(
      "BANK_TRANSFER"
    );
  ...
  if (!project) {
    return (
      <div className="mx-auto max-w-3xl p-8 text-center text-red-700">
        {error ||
          "Project not found"}
      </div>
    );
      ...
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[.8fr_1.2fr]">
        ...
        >
          <div className="flex items-start gap-3 rounded-2xl bg-emerald-50 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-800">
                Your NID number is collected
                for Admin verification only.
                It is not shown to the project
                owner, other farmers, or on
                the public investment page.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-5">
            ...
            <label className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setPaymentMethod(
                    e.target
                      .value as InvestmentPaymentMethod
                  )
                }
                className="w-full rounded-xl border border-slate-200 px-4 py-3 outline-none focus:border-emerald-600"
              >
            ...
            <label className="space-y-2">
              ...
              <textarea
                ...
                maxLength={800}
                className="w-full rounded-xl border border-slate-200 px-4 py-3 outline-none focus:border-emerald-600"
                placeholder="Anything Admin should know about this investment request"
              />
            </label>
          </div>
          ...
          <button
            ...
            className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-3.5 font-black text-white hover:bg-emerald-800 disabled:opacity-50"
          >
            {submitting && (
