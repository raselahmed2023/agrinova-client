  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#063B2B] via-[#0B513D] to-[#063B2B] px-4 py-16 text-white sm:px-6 sm:py-24 lg:px-8">
        <div className="absolute inset-0 bg-[radial-gradient(#a7f3d0_1px,transparent_1px)] opacity-10 [background-size:16px_16px]" />
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-500/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-emerald-300 backdrop-blur-sm">
            ...
            <span>
              AgriNova Agricultural Knowledge Hub
            </span>
          </div>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-emerald-100 sm:text-lg">
            Discover field-tested techniques, crop
            pathology solutions, and modern precision
            farming breakthroughs written directly by
          ...
          <div className="mx-auto mt-8 max-w-2xl">
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-emerald-400/30 bg-white py-3.5 pl-12 pr-16 text-sm text-slate-900 shadow-xl placeholder:text-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-400/40"
              />
        ...
        {loading ? (
          ...
          <div className="my-16 rounded-3xl border border-dashed border-slate-300 bg-white p-12 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">
              ...
              your search criteria. Try a different keyword
              or category.
            </p>
                ...
                <div className="relative overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-white to-emerald-50/40 p-6 shadow-sm transition hover:shadow-md lg:p-8">
                  <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
                    ...
                    <div className="lg:col-span-5">
                      <div className="group relative aspect-video overflow-hidden rounded-2xl border border-slate-200 shadow-inner sm:aspect-[4/3]">
                        <Image
                          src={
                        ...
                        {featuredBlog.images &&
                          featuredBlog.images.length > 1 && (
                            <div className="absolute bottom-3 right-3 flex items-center gap-1.5 rounded-lg bg-black/70 px-2.5 py-1 text-[11px] font-semibold text-white backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                selectedCategory !== "All"
                  ...
                  <article
                    ...
                    className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition duration-200 hover:-translate-y-1 hover:shadow-md"
                  >
                    <div className="group relative aspect-video w-full overflow-hidden bg-slate-100">
                      ...
                      <div className="absolute left-3 top-3">
                        <span className="rounded-lg bg-white/90 px-2.5 py-1 text-[11px] font-bold text-[#063B2B] shadow-sm backdrop-blur-sm">
                          {blog.category}
                        </span>
                      </div>
                      ...
                      {blog.images &&
                        blog.images.length > 1 && (
                          <div className="absolute bottom-3 right-3 flex items-center gap-1 rounded-md bg-black/60 px-2 py-0.5 text-[10px] font-medium text-white backdrop-blur-sm">
                            <ImageIcon className="h-3 w-3" />
                            <span>2 Photos</span>
                          </div>
                        )}
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <Link
                        ...
                        className="mt-2.5"
                      >
                        <h4 className="line-clamp-2 text-base font-bold leading-snug text-slate-900 transition hover:text-[#063B2B]">
                          {blog.title}
                        </h4>
                      </Link>
                      ...
                      <div className="mt-5 flex items-center justify-between border-t border-slate-100 pt-3.5">
                        ...
                        <Link
                          ...
                          className="inline-flex shrink-0 items-center gap-1 text-xs font-bold text-[#063B2B] hover:text-[#0B513D]"
                        >
                          Read
