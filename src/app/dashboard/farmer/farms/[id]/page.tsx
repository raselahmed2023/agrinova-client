    ...
    return (
      <div className="min-h-screen p-8 max-w-[1200px] mx-auto text-center space-y-3">
        ...
        <Link
          ...
          className="text-emerald-600 hover:underline inline-block text-sm font-semibold"
        >
          Back to Farms List
        </Link>
      </div>
        ...
        <div className="px-8 pb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2 bg-slate-50 p-6 rounded-xl border border-slate-100 space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              {farm.description ||
                'No additional details provided for this farm location. Update farm details using the edit button above.'}
            </p>
          </div>
